...
template <typename T>
/* Eu tiro o primeiro elemento
1) Verificar se esta vazia
1.1) Throw em Exception
2) Verificar se o tamanho eh 1
2.1) tail = nullptr
3) head = head->next
4) Guardar o valor do dado em um T temporario
5) deletar temp (ponteiro para o elemento que sera removido)
6) Retornar o T
*/
